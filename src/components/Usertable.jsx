  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-4">
        ...
        <button className="bg-blue-600 text-white px-4 py-2 rounded-md">+ New User</button>
      </div>
              ...
              <tr key={user.id}>
                ...
                <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                  <div className="flex items-center">
                    <img src={user.avatar} alt="avatar" className="w-10 h-10 rounded-full mr-4" />
                    <div>
                ...
                <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                  <div className="text-sm leading-5 text-gray-900">{user.verified}</div>
                </td>
                <td className="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
